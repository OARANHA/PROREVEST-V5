...
export const meta: MetaFunction = () => {
  return [
    { title: "Esqueci minha senha - ProRevest" },
    { name: "description", content: "Recupere o acesso à sua conta ProRevest." },
  ];
}
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        setMessage("Instruções para redefinir sua senha foram enviadas para seu email. Verifique sua caixa de entrada.");
      }
    } catch (err) {
      setError("Ocorreu um erro ao enviar as instruções. Por favor, tente novamente.");
    } finally {
      setIsLoading(false);
    }
  };
