...
export async function loader() {
  try {
    ...
    return json({ success: true, message: "Perfis criados com sucesso." });
  } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-dark-background flex items-center justify-center">
      <div className="bg-dark-card p-8 rounded-xl shadow-lg text-center">
        <h1 className="text-2xl font-cormorant font-bold text-dark-primary mb-4">Inicializando Perfis</h1>
        <p className="text-dark-muted-foreground mb-6">Criando perfis para usuários existentes...</p>
