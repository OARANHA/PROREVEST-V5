...
async function createProfileForAranha() {
  try {
    const userId = '56f23118-3ee3-457f-8aea-7061ee6134f7';
    const userEmail = 'aranha.com@gmail.com';
    const userFullName = 'alessandro Aranha Delfino';
